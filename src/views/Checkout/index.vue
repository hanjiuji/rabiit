...
import {ref} from "vue";
import {createOrderAPI} from "@/api/checkout.ts"
...
const curAddress:object = ref({}); // 地址对象
...
getCheckoutInfo()
const activeAddress:object = ref({})
...
<template>
  ...
  <el-dialog title="切换收货地址" width="30%" center v-model="showDialog">
    ...
    <span class="dialog-footer">
      ...
      <el-button type="primary" @click="comfer">确定</el-button>
    </span>
    </template>
  </el-dialog>
  <!-- 省略 -->
